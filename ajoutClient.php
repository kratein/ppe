...
<?php include ('bdd.php');
?>
<form method="post" action="PhpajoutClient.php" >
	<head>
	 <title>Ajout d'un client</title>
     <h1><center>Formulaire d'ajout d'un Client</center></h1>
	 <style type="text/css">
...
// ]]> -->
	 ...
	 <table>
		...
		<td width = '600'>
		<input onclick="ds_sh(this);" name="DATE_NAISSANCE" readonly="readonly" style="cursor: text"/>
		</td></tr>
		
		<tr>
		<td width = '200'> Rue </td>
		<td width = '600'>
		<input type="text" name="RUE" size ="50"/>
		</td></tr>
		...
		<td width = '600'>
		<input type="text" name="VILLE" size ="15"/>
		</td></tr>
		...
		<td width = '600'>
		<input type="text" name="COMMENTAIRE" size ="500"/>
		</td></tr>
